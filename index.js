...
const UUID = process.env.UUID || 'C6BE152C-1EFC-8F5C-E0EB-B1A5AE30A890'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'IE3tj6tvKuytMasgSk2VskG9GTyGP6vK';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const SUB_PATH = process.env.SUB_PATH || 'subkey660';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'public';                       // 节点名称
